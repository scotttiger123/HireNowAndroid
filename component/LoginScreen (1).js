  ...
  const handleLogin = async () => {
    try {
      ...
      if (responseData.success) {
        ...
        await AsyncStorage.setItem('userRegisterType', responseData.user.register_type);
...
const styles = StyleSheet.create({
  cancelButtonContainer: {
    ...
    zIndex: 1, // Ensure the cancel button is above other elements
  },
  forgotPasswordLink:{
    marginLeft:15,
    fontSize: 14,
  ...
  loginButton: {
    backgroundColor: '#694fad', // Set button color to #164081
    padding: 10,
    margin:5,
    marginTop:10,
    borderRadius: 8,
